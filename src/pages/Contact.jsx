            ...
            <div class="flex justify-center">
                <div class="grid md:grid-cols-2">
                        ...
                        <ul>
                            <li class="flex">
                                ...
                                <div class="m-5">
                                    ...
                                    <p class="text-gray-400">Biratnagar</p>
                                    <p class="text-gray-400">Biratnagar </p>
                                </div>
                            </li>
                            <li class="flex">
                                ...
                                <div class="m-5">
                                    ...
                                    <p class="text-gray-400">Mobile: 9811317964</p>
                                    <p class="text-gray-400">Mail:sunilkarki670@gmail.com</p>
                                </div>
                            </li>
                            <li class="flex">
                                ...
                                <div class="m-5">
                                    <h3 class="text-lg font-bold text-gray-200">Working
                                        hours</h3>
                                    <p class="text-gray-400">Sunday - Friday: Anytime Available </p>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="max-w-6xl p-5 md:p-12" id="form">
                        ...
                        <form action="https://getform.io/f/rbeqjxrb" method="POST">
                            <div class="mb-6">
                                <div class="mx-0 mb-1 sm:mb-4">
                                    <div class="mx-0 mb-1 sm:mb-4">
                                        <input type="text" id="name" autocomplete="given-name" placeholder="Your name" class="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 sm:mb-0" name="name" required/>
                                    </div>
                                    <div class="mx-0 mb-1 sm:mb-4">
                                        <input type="email" id="email" autocomplete="email" placeholder="Your email address" class="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 sm:mb-0" name="email" required/>
                                    </div>
                                </div>
                                <div class="mx-0 mb-1 sm:mb-4">
                                    <textarea id="textarea" name="textarea" cols="30" rows="5" placeholder="Write your message..." class="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4sm:mb-0 " required></textarea>
                                </div>
                            </div>
